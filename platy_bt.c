 ...
 *  Purpose:This is the main program for Assignment #1, CST8152, Fall 2015
 *  Version; 1.15.2
...
#define _CRTDBG_MAP_ALLOC /*for mem leak check */

#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <stdarg.h>
#include <crtdbg.h>/*for mem leak check */
...
int main(int argc, char **argv){
   ...
   _CrtDumpMemoryLeaks(); /*for mem leak check */
   _CrtSetDbgFlag(_CRTDBG_ALLOC_MEM_DF|_CRTDBG_LEAK_CHECK_DF); /*for mem leak check */
